...
<head>
  ...
  <link rel="stylesheet" href="HomePage.css?v=2.0" />
</head>
<body>
  <!-- Navbar -->
  <header class="navbar">
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <a href="#" class="btn">Pesan Tiket Sekarang</a>
    </div>
  </section>
  ...
  <section class="kategori">
    <div class="container">
      ...
      <div class="kategori-grid">
        <div class="card">
          <img src="../images/Wisata Alam (1).png" alt="Wisata Alam" />
          <h3>Wisata Alam</h3>
          <p>Menikmati pesona alam indah di area Malang Raya.</p>
        </div>
        <div class="card">
          <img src="../images/WisataBuatan.png" alt="Wisata Buatan" />
          <h3>Wisata Buatan</h3>
          <p>Menikmati wahana buatan modern dan beragam hiburan keluarga.</p>
        </div>
        <div class="card">
          <img src="../images/Wisata Edukasi.png" alt="Wisata Edukasi" />
