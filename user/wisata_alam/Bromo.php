...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/Bromo.png" alt="Gunung Bromo" class="hero-img">
    ...
    <script>
        const regularPricePerTicket = 155000;
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'gunung-bromo',
                destination_name: 'Gunung Bromo',
                destination_href: 'user/wisata_alam/Bromo.php',
