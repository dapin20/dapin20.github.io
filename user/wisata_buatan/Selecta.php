...
<head>
    ...
    <title>WisataKu - Taman Rekreasi Selecta</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="https://selectawisata.id/wp-content/uploads/2023/12/20230105-DSC04944-scaled.jpg" alt="Taman Rekreasi Selecta" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../../dashboard/home.php">Home</a> / <a href="WisataBuatan.php">Wisata Buatan</a> / Taman Rekreasi Selecta
                </nav>
                ...
                <div class="stats-bar">
                    <div class="stat-item">
                        ...
                        <span class="value">(1.8k review)</span>
                    </div>
                    <div class="stat-item">
                ...
                <div class="description">
                    <p>Taman Rekreasi Selecta adalah destinasi legendaris di Kota Batu yang terkenal dengan taman bunganya yang indah dan udara pegunungan yang sejuk.</p>
                    <br>
                    <p>Selain taman bunga, Selecta juga menawarkan berbagai fasilitas rekreasi seperti kolam renang air dingin, flying fox, perahu ayun, hingga area berkuda. Tempat ini telah menjadi favorit lintas generasi untuk berwisata keluarga sejak masa kolonial.</p>
                </div>
            ...
            <aside class="sidebar-sticky">
                <div class="booking-card">
                    <div class="price-box">
                        ...
                        <div class="price-value">Rp 40.000 <span>/ orang</span></div>
                    </div>
                    ...
                    <div class="total-payment">
                        ...
                        <div class="total-price" id="totalPriceDisplay">Rp 40.000</div>
                    </div>
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const message = `Halo Admin WisataKu, saya mau pesan ${amount} tiket Taman Rekreasi Selecta for tanggal ${date}. Total tagihan: Rp ${total.toLocaleString('id-ID')}`;
