...
<head>
    ...
    <title>WisataKu - Kesembon Park</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/buatan4.png" alt="Kesembon Park" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../../dashboard/home.php">Home</a> / <a href="WisataBuatan.php">Wisata Buatan</a> / Kesembon Park
                </nav>
                ...
                <div class="description">
                    <p>Kesembon Park menawarkan pengalaman wisata outdoor yang seru dengan berbagai fasilitas menarik seperti kolam renang, area outbound, dan rafting.</p>
                    <br>
                    <p>Terletak di kawasan yang asri, tempat ini sangat cocok untuk kegiatan gathering perusahaan, sekolah, maupun liburan keluarga yang ingin menikmati suasana alam sambil beraktivitas fisik yang menyenangkan.</p>
                </div>
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const message = `Halo Admin WisataKu, saya mau pesan ${amount} tiket Kesembon Park for tanggal ${date}. Total tagihan: Rp ${total.toLocaleString('id-ID')}`;
