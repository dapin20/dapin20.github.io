...
<head>
    ...
    <title>WisataKu - Fantasy Land</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/buatan5.png" alt="Fantasy Land" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../../dashboard/home.php">Home</a> / <a href="WisataBuatan.php">Wisata Buatan</a> / Fantasy Land
                </nav>
                ...
                <div class="description">
                    <p>Fantasy Land adalah taman bermain indoor yang menawarkan berbagai wahana seru untuk anak-anak dan keluarga dalam suasana yang penuh warna dan imajinasi.</p>
                    <br>
                    <p>Nikmati berbagai permainan interaktif, mandi bola, hingga wahana simulasi yang edukatif. Tempat ini merupakan pilihan tepat untuk mengisi akhir pekan bersama si kecil tanpa perlu khawatir dengan cuaca di luar.</p>
                </div>
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const message = `Halo Admin WisataKu, saya mau pesan ${amount} tiket Fantasy Land for tanggal ${date}. Total tagihan: Rp ${total.toLocaleString('id-ID')}`;
