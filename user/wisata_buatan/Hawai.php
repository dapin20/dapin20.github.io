...
<head>
  <script src="../../assets/js/theme.js?v=3.4"></script>
    ...
    <title>WisataKu - Hawai Waterpark</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="https://i.pinimg.com/1200x/da/84/79/da8479cd17c9ab4862c2622193d5760f.jpg" alt="Hawai Waterpark" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../../dashboard/home.php">Home</a> / <a href="WisataBuatan.php">Wisata Buatan</a> / Hawai Waterpark
                </nav>
                
                <h1>Hawai Waterpark</h1>
                ...
                <div class="description">
                    <p>Hawai Waterpark merupakah salah satu waterpark terbaik di Indonesia. Dibangun di lahan seluas 28.000 meter persegi dan terletak di Perumahan Graha Kencana Jl. Balearjosari Malang.</p>
                    <br>
                    <p>Hawai Waterpark memiliki berbagai macam wahana air dan wahana kering dengan sistem keamaan tinggi dan lifeguard bersertifikat Internasional. Beberapa wahana yang dikenal luas di masyarakat antara lain Kolam Ombak Tsunami dengan ombak tertinggi di Indonesia, Jet Coaster Water Slide dengan tower tertinggi di Indonesia, serta kolam arus dengan 8 tema yang berbeda.</p>
                </div>
    ...
    <script>
        const regularPricePerTicket = 100000;
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'hawai-waterpark',
                destination_name: 'Hawai Waterpark',
                destination_href: 'user/wisata_buatan/Hawai.php',
