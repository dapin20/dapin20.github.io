...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/Buatan2.png" alt="Malang Night Paradise" class="hero-img">
    ...
    <script>
        const regularPricePerTicket = 90000;
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'malang-night-paradise',
                destination_name: 'Malang Night Paradise',
                destination_href: 'user/wisata_buatan/MalangNightParadise.php',
