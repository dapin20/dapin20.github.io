...
<head>
    ...
    <title>WisataKu - Jatim Park 1</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="https://i.pinimg.com/736x/39/fc/1c/39fc1c4b828e4b116dc09d82f590219c.jpg" alt="Jatim Park 1" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../dashboard/home.php">Home</a> / <a href="WisataBuatan.php">Wisata Buatan</a> / Jatim Park 1
                </nav>
                ...
                <div class="stats-bar">
                    <div class="stat-item">
                        ...
                        <span class="value">(2.1k review)</span>
                    </div>
                    <div class="stat-item">
                ...
                <div class="description">
                    <p>Jatim Park 1 adalah taman rekreasi yang memadukan konsep wahana hiburan dengan edukasi budaya dan ilmu pengetahuan. Berlokasi di Kota Batu, taman ini menawarkan puluhan wahana seru yang memacu adrenalin.</p>
                    <br>
                    <p>Selain wahana permainan, pengunjung juga dapat mengunjungi Galeri Etnik Nusantara dan Science Center untuk menambah wawasan. Jatim Park 1 sangat cocok untuk liburan keluarga yang edukatif dan menyenangkan.</p>
                </div>
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const message = `Halo Admin WisataKu, saya mau pesan ${amount} tiket Jatim Park 1 for tanggal ${date}. Total tagihan: Rp ${total.toLocaleString('id-ID')}`;
