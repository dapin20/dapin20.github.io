...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/batu_secret_zoo.jpg" alt="Batu Secret Zoo" class="hero-img">
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'batu-secret-zoo',
                destination_name: 'Batu Secret Zoo',
                destination_href: 'user/wisata_edukasi/BatuSecretZoo.php',
                price: '120000',
                quantity: amount,
                visit_date: date
            };
