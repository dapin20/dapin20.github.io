...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/museum_brawijaya.jpg" alt="Museum Brawijaya" class="hero-img">
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'museum-brawijaya',
                destination_name: 'Museum Brawijaya',
                destination_href: 'user/wisata_edukasi/MuseumBrawijaya.php',
                price: '10000',
                quantity: amount,
                visit_date: date
            };
