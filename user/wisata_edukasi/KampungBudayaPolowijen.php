...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/kampung_budaya_polowijen.jpg" alt="Kampung Budaya Polowijen" class="hero-img">
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'kampung-budaya-polowijen',
                destination_name: 'Kampung Budaya Polowijen',
                destination_href: 'user/wisata_edukasi/KampungBudayaPolowijen.php',
                price: '10000',
                quantity: amount,
                visit_date: date
            };
