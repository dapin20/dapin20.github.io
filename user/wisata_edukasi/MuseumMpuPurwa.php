...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/museum_mpu_purwa.jpg" alt="Museum Mpu Purwa" class="hero-img">
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'museum-mpu-purwa',
                destination_name: 'Museum Mpu Purwa',
                destination_href: 'user/wisata_edukasi/MuseumMpuPurwa.php',
                price: '10000',
                quantity: amount,
                visit_date: date
            };
