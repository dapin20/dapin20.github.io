...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/museum_zoologi_frater_vianney.jpg" alt="Museum Zoologi Frater Vianney" class="hero-img">
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'museum-zoologi-frater-vianney',
                destination_name: 'Museum Zoologi Frater Vianney',
                destination_href: 'user/wisata_edukasi/MuseumZoologiFraterVianney.php',
                price: '10000',
                quantity: amount,
                visit_date: date
            };
