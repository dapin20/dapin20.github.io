...
<body>
    ...
    <div class="hero-wrapper">
        <img src="../../assets/images/predator_fun_park.jpg" alt="Predator Fun Park" class="hero-img">
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const fields = {
                destination_id: 'predator-fun-park',
                destination_name: 'Predator Fun Park',
                destination_href: 'user/wisata_edukasi/PredatorFunPark.php',
                price: '50000',
                quantity: amount,
                visit_date: date
            };
