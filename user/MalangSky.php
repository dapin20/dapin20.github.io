...
<head>
    ...
    <title>WisataKu - Malang Skyland</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="https://asset.kompas.com/crops/qVZ7dLMU2uwDODrZrSWLni3yUkI=/0x363:765x873/1200x800/data/photo/2023/12/26/658a7bf12e3f1.jpeg" alt="Malang Skyland" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../dashboard/home.php">Home</a> / <a href="WisataBuatan.php">Wisata Buatan</a> / Malang Skyland
                </nav>
                ...
                <div class="stats-bar">
                    ...
                    <div class="stat-item">
                        ...
                        <span class="label">Kab. Malang, Jatim</span>
                    </div>
                    <div class="stat-item">
                        <span class="icon">🎡</span>
                ...
                <div class="description">
                    <p>Malang Skyland adalah destinasi wisata modern di Kabupaten Malang yang menawarkan konsep wisata ketinggian dengan pemandangan alam pegunungan dan kota yang indah.</p>
                    <br>
                    <p>Tempat ini memiliki berbagai wahana seperti Sky Bridge dan Sky Glass yang menguji adrenalin, banyak spot foto Instagramable, area bermain anak, serta fasilitas penyewaan skuter listrik dan sepeda listrik. Selain itu, ada juga tenant kuliner dan pertunjukan live music di malam hari.</p>
                </div>

                <div class="map-wrapper">
                    <button class="map-btn" onclick="window.location.href='https://maps.app.goo.gl/8S2uT4wFSaYUeZmH6'"><img src="../assets/icon/map-pin-line2.svg" alt="Location" style="width: 16px; height: 16px; margin-right: 5px; display: inline-block;"/> Lihat di Google Maps</button>
                </div>
            </main>
            ...
            <aside class="sidebar-sticky">
                <div class="booking-card">
                    <div class="price-box">
                        ...
                        <div class="price-value">Rp 35.000 <span>/ orang</span></div>
                    </div>
                    ...
                    <div class="total-payment">
                        ...
                        <div class="total-price" id="totalPriceDisplay">Rp 35.000</div>
                    </div>
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const message = `Halo Admin WisataKu, saya mau pesan ${amount} tiket Malang Skyland untuk tanggal ${date}. Total tagihan: Rp ${total.toLocaleString('id-ID')}`;
