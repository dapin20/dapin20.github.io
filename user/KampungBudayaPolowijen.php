...
<head>
    ...
    <title>WisataKu - Kampung Budaya Polowijen</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="https://lh3.googleusercontent.com/gps-cs-s/AG0ilSyridUvPL3cMoK9yAXNAMfEacZc5_ZxAWouTh4sZ-dFNykKZZHk2QPul2P_yLHwi_PDJvwtCQ0mVKLYFDv4zY06qo_K9UFRavSCpST1sy-Rtm3KufIY_XDPypsimi5jnHmGa6P1=s294-w294-h220-n-k-no" alt="Kampung Budaya Polowijen" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../dashboard/home.php">Home</a> / <a href="WisataEdukasi.php">Wisata Edukasi</a> / Kampung Budaya Polowijen
                </nav>
                
                <h1>Kampung Budaya Polowijen</h1>
                
                <div class="stats-bar">
                    <div class="stat-item">
                        <span class="icon">⭐</span>
                        <span class="label">4.6</span>
                        <span class="value">(300 review)</span>
                    </div>
                    <div class="stat-item">
                ...
                <div class="description">
                    <p>Kampung Budaya Polowijen adalah destinasi wisata budaya di Kota Malang yang melestarikan berbagai warisan budaya lokal, seperti pembuatan topeng Malangan, tari-tarian tradisional, dan batik.</p>
                    <br>
                    <p>Pengunjung dapat belajar langsung cara membuat topeng, menari, atau membatik dari para pengrajin dan seniman setempat. Tempat ini menawarkan pengalaman imersif dalam kehidupan budaya masyarakat Malang yang masih terjaga keasliannya.</p>
                </div>
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const message = `Halo Admin WisataKu, saya mau pesan ${amount} tiket Kampung Budaya Polowijen untuk tanggal ${date}. Total tagihan: Rp ${total.toLocaleString('id-ID')}`;
