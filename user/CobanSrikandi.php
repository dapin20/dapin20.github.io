...
<head>
    ...
    <title>WisataKu - Coban Srikandi Immersive Experience</title>
...
<body>
    ...
    <div class="hero-wrapper">
        <img src="https://i.pinimg.com/736x/b0/a7/10/b0a71008cd248b24c4a5dca9a5a6f5f6.jpg" alt="Coban Srikandi" class="hero-img">
        ...
        <div class="content-grid">
            ...
            <main class="main-content">
                <nav class="breadcrumb">
                    <a href="../dashboard/home.php">Home</a> / <a href="WisataAlam.php">Wisata Alam</a> / Coban Srikandi
                </nav>
                
                <h1>Coban Srikandi</h1>
                
                <div class="stats-bar">
                    <div class="stat-item">
                        <span class="icon">⭐</span>
                        <span class="label">4.6</span>
                        <span class="value">(420 review)</span>
                    </div>
                    <div class="stat-item">
                        <span class="icon"><img src="../assets/icon/map-pin-line2.svg" alt="Location" style="width: 16px; height: 16px;"/></span>
                        <span class="label">Tumpang, Malang</span>
                    </div>
                    <div class="stat-item">
                        <span class="icon">🌊</span>
                ...
                <div class="description">
                    <p>Coban Srikandi adalah salah satu air terjun tersembunyi di kawasan Tumpang, Malang. Air terjun ini menawarkan keindahan alam yang masih sangat alami dengan aliran air yang jernih dan segar.</p>
                    <br>
                    <p>Dikelilingi oleh tebing batu dan pepohonan hijau yang rimbun, Coban Srikandi memberikan suasana yang tenang dan damai. Tempat ini sangat cocok bagi Anda yang ingin melepas penat dari hiruk-pikuk kota sambil menikmati suara gemercik air yang menenangkan.</p>
                </div>
            </main>
    ...
    <script>
        ...
        function orderTicket() {
            ...
            const message = `Halo Admin WisataKu, saya mau pesan ${amount} tiket Coban Srikandi untuk tanggal ${date}. Total tagihan: Rp ${total.toLocaleString('id-ID')}`;
